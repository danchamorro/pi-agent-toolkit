...
description: "Run the CodeRabbit CLI for AI-powered review. Use only when the user explicitly asks for CodeRabbit or invokes coderabbit-review. Never trigger for a generic code review, PR review, quality check, security audit, or autonomously."
metadata:
  version: "0.1.0"
---
...
Run an AI-powered review through the CodeRabbit CLI. CodeRabbit can take a long time, so require an explicit CodeRabbit request rather than treating this as the default code-review workflow.
...
- Asks to run or use CodeRabbit
- Asks to use the CodeRabbit CLI
- Invokes `coderabbit-review`

Do not use it for generic requests to review code, review a PR, check quality, find bugs, or audit security. Do not invoke it autonomously.
...
### 4. Fix Issues When Requested

When the user explicitly requests implementation plus CodeRabbit review:
