...
For the up-the-org version of this same content, hand the finished post-mortem to [`management-talk`](../../docs-communication/management-talk/SKILL.md). They compose: post-mortem owns the engineering truth, management-talk reframes it for leadership.
