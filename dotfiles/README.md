...
dotfiles/
  ...
  extensions/ ......... 22 single-file + 2 directory-based extensions
...
| `find-session.ts` | Searches saved Pi sessions in a dedicated TUI, ranks matches with the active model, and resumes directly into the selected session. |
